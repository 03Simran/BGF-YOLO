...
class YOLO:
    ...
    Methods:
        ...
        predict(source=None, stream=False, **kwargs) -> List[...yolo.engine.results.Results]:
            Performs prediction using the YOLO model.

    Returns:
        list(...yolo.engine.results.Results): The prediction results.
    """
    ...
    def track(self, source=None, stream=False, persist=False, **kwargs):
        ...
        Returns:
            (List[...yolo.engine.results.Results]): The tracking results.
